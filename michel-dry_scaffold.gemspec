...
Gem::Specification.new do |s|
  s.name = %q{michel-dry_scaffold}
  s.version = "0.3.5"

  s.required_rubygems_version = Gem::Requirement.new(">= 0") if s.respond_to? :required_rubygems_version=
  s.authors = ["Jonas Grimfelt,Michel de Graaf"]
  s.date = %q{2009-10-24}
  ...
  s.email = %q{grimen@gmail.com, michel@re-invention.nl}
  ...
  s.homepage = %q{http://github.com/grimen/michel-dry_scaffold/tree/master}
